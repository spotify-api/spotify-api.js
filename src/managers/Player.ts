...
export class Player {
	...
	public getCurrentPlayback(additionalTypes?: "track" | "episode"): Promise<CurrentPlayback | null> {
		return this.client
			.fetch("/me/player", { params: { additional_types: additionalTypes } })
	...
	public getCurrentlyPlaying(additionalTypes?: "track" | "episode"): Promise<CurrentPlayback | null> {
		return this.client
			.fetch("/me/player/currently-playing", { params: { additional_types: additionalTypes } })
	...
	public getRecentlyPlayed(options: Partial<Cursor> & { limit?: number } = {}): Promise<RecentlyPlayed> {
		return this.client
			.fetch("/me/player/recently-played", { params: options })
			.then(x => createRecentlyPlayed(this.client, x));
	}
